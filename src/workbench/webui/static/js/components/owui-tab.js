...
(function () {
  ...
  function renderOwuiTab(container) {
    container.innerHTML = ''
      ...
      +       '<button class="btn btn-secondary btn-sm" id="btn-owui-retry" data-tooltip="Re-check whether the Open WebUI server is reachable. Use this if Open WebUI was restarted." data-help-page="/static/help/open-webui.html#retry">Retry</button>'
      +       '<a href="/open-webui/" target="_blank" class="btn btn-primary btn-sm" style="text-decoration:none" data-tooltip="Open the full Open WebUI interface in a separate browser tab without the Workbench wrapper." data-help-page="/static/help/open-webui.html#open-new-tab">Open in New Tab</a>'
      +     '</div>'
      +   '</div>'
  ...
  function showOwuiActive() {
    ...
    content.innerHTML = ''
      ...
      +     '<a href="/open-webui/" target="_blank" class="btn btn-primary btn-sm" style="text-decoration:none" data-tooltip="Open the full Open WebUI interface in a separate browser tab." data-help-page="/static/help/open-webui.html#open-new-tab">Open in New Tab</a>'
      +   '</div>'
