...
(function () {
  ...
  function renderProgressPanel(topic, roundsCompleted, maxRounds, status) {
    ...
    return ''
      ...
      +     '<button class="btn btn-warning btn-sm" id="btn-pause-debate" onclick="window.debatePause(this)">Pause</button>'
      +     '<button class="btn btn-success btn-sm" id="btn-resume-debate" onclick="window.debateResume(this)" disabled>Resume</button>'
      ...
      +       '</div>'
      +       '<button class="btn btn-primary btn-sm" onclick="window.debateInject(this)">Inject</button>'
      +     '</div>'
      +   '</div>'
      + '</div>'
      + '</div>';
