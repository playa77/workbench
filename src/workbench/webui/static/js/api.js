const API = (() => {
  ...
  return {
    ...
    getInferenceConfig: function() { return request('GET', '/api/v1/me/inference-config'); },
    updateInferenceConfig: function(data) { return request('PUT', '/api/v1/me/inference-config', data); },
    deleteInferenceConfig: function() { return request('DELETE', '/api/v1/me/inference-config'); },
    getInferenceProviders: function() { return request('GET', '/api/v1/me/inference-providers'); },
    createInferenceProvider: function(data) { return request('POST', '/api/v1/me/inference-providers', data); },
    updateInferenceProvider: function(id, data) { return request('PUT', '/api/v1/me/inference-providers/' + id, data); },
    deleteInferenceProvider: function(id) { return request('DELETE', '/api/v1/me/inference-providers/' + id); },
    setDefaultProvider: function(id) { return request('POST', '/api/v1/me/inference-providers/' + id + '/default'); },
    getServerConfig: function() { return request('GET', '/api/v1/admin/server-config'); },
    updateServerConfig: function(data) { return request('PUT', '/api/v1/admin/server-config', data); },
