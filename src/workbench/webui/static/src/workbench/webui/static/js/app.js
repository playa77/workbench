...
(function () {
  ...
  function renderBraveKeySection(container, currentUser) {
    ...
    var keyStatusHtml = hasBraveKey
      ? '<div style="margin-bottom:8px;font-size:12px;color:var(--text-muted)">Current key: <code style="font-size:12px;background:var(--bg-code);padding:1px 6px;border-radius:3px">' + Utils.escapeHtml(braveMasked) + '</code></div>'
      : '';
    container.innerHTML +=
      '<div class="settings-section">' +
